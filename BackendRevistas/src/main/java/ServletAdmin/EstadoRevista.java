 ...
 * @author marco
 */
@WebServlet(name = "EstadoRevista", urlPatterns = {"/EstadoRevista"})
@MultipartConfig()
public class EstadoRevista extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ArrayList<Revista> revistas = obAd.obtenerRevistaPendiente(1);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Info info = ctlAd.cambiarEstadoRevista(revista);
